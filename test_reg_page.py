...
def test_reg_page(browser):
    ...
    print("\nПереход на страницу регистрации - Успешно ")
    print("\nТест - Пройден")
...
def test_reg_page_registration(browser_reg_page):
    ...
    print("\nПереход на страницу получения кода подтверждения - Успешно ")
    print("\nТест - Пройден")
...
def test_reg_page_no_data(browser_reg_page):
    ...
    and mail_error_message.text == 'Введите телефон в формате +7ХХХХХХХХХХ, или email в формате example@email.ru' \
